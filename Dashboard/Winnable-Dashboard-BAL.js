...
function kendoGrid_AllProposal_Bind() {
    ...
    (<any>$("#divProposal_GridView")).kendoGrid({
        dataSource: {
            type: "odata",
            transport: {
...
function AllProposal_FullCalendarView_Bind() {
    (<any>$("#divProposal_FullCalendarView")).kendoScheduler({
            ...
            transport: {
                ...
                parameterMap: function (options, operation) {
                    if (operation !== "read" && options.models) {
                        return { models: <any>kendo.stringify(options.models) };
                    }
                }
            },
            schema: {
...
function bindGridView_StatusBySection() {
    ...
    (<any>$("#grid_StatusByBySection")).kendoGrid({
        dataSource: {
            type: "odata",
            transport: {
...
function bindGridView_StatusByReview() {
    ...
    (<any>$("#grid_StatusByReview")).kendoGrid({
        dataSource: {
            type: "odata",
            transport: {
                read: "https://demos.telerik.com/kendo-ui/service/Northwind.svc/Orders"
...
function createChart_StatusBySection() {
    ...
    $(".poll-results div").each(function () {
        var pb = (<any>$(this)).kendoProgressBar({
            type: "percent",
            ariaRole: true,
            animation: {
                duration: 600
