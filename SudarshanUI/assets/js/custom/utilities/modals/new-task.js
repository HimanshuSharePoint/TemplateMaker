...
var KTModalNewTarget = function () {
    ...
    return {
        init: function () {
            (i = document.querySelector("#kt_modal_new_task")) && (o = new bootstrap.Modal(i), a = document.querySelector("#kt_modal_new_task_form"), t = document.getElementById("kt_modal_new_task_submit"), e = document.getElementById("kt_modal_new_task_cancel"), new Tagify(a.querySelector('[name="tags"]'), {
