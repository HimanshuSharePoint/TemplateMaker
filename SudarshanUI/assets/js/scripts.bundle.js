...
class KTDialer {
    ...
    static createInstances(e = '[data-kt-dialer="true"]') {
...
class KTDrawer {
    ...
    static hideAll(e = null, t = '[data-kt-drawer="true"]') {
    ...
    static updateAll(e = '[data-kt-drawer="true"]') {
    ...
    static createInstances(e = '[data-kt-drawer="true"]') {
...
class KTFeedback {
    constructor(e) {
        var t = this, n = document.getElementsByTagName("BODY")[0], i = {
            width: 100,
...
class KTImageInput {
    ...
    static createInstances(e = "[data-kt-image-input]") {
        var t = document.querySelectorAll(e);
        if (t && t.length > 0)
            for (var n = 0, i = t.length; n < i; n++)
...
class KTMenu {
        ...
        if (null != e) {
            var i = {
                ...
                if (!1 !== KTEventHandler.trigger(n.element, "kt.menu.dropdown.show", e)) {
                    ...
                    c(e) || p(e);
                    var t = g(e), i = I(e, "width"), r = I(e, "height"), o = n.options.dropdown.zindex, a = KTUtil.getHighestZindex(e);
    ...
    static createInstances(e = '[data-kt-menu="true"]') {
        var t = document.querySelectorAll(e);
        if (t && t.length > 0)
            for (var n = 0, i = t.length; n < i; n++)
                new KTMenu(t[n]);
...
class KTPasswordMeter {
    constructor(e, t) {
        ...
        if (e) {
            var i = {
                ...
                var e = n.visibilityElement.querySelector("i:not(.d-none), .svg-icon:not(.d-none)"), t = n.visibilityElement.querySelector("i.d-none, .svg-icon.d-none");
    ...
    static createInstances(e = "[data-kt-password-meter]") {
        var t = document.body.querySelectorAll(e);
        if (t && t.length > 0)
            for (var n = 0, i = t.length; n < i; n++)
...
class KTScroll {
    ...
    static createInstances(e = '[data-kt-scroll="true"]') {
        var t = document.getElementsByTagName("BODY")[0].querySelectorAll(e);
        if (t && t.length > 0)
            for (var n = 0, i = t.length; n < i; n++)
                new KTScroll(t[n]);
...
class KTScrolltop {
    ...
    static createInstances(e = '[data-kt-scrolltop="true"]') {
        var t = document.getElementsByTagName("BODY")[0].querySelectorAll(e);
        if (t && t.length > 0)
            for (var n = 0, i = t.length; n < i; n++)
                new KTScrolltop(t[n]);
...
class KTSticky {
    constructor(e, t) {
        ...
        if (null != e) {
            var r = {
                ...
                var t = d("top"), i = d("left"), r = d("right"), o = d("width"), a = d("zindex"), l = d("dependencies"), s = d("class"), c = u();
    ...
    static createInstances(e = '[data-kt-sticky="true"]') {
        var t = document.getElementsByTagName("BODY")[0].querySelectorAll(e);
        if (t && t.length > 0)
            for (var n = 0, i = t.length; n < i; n++)
                new KTSticky(t[n]);
...
class KTSwapper {
    ...
    static createInstances(e = '[data-kt-swapper="true"]') {
        var t = document.querySelectorAll(e);
        if (t && t.length > 0)
            for (var n = 0, i = t.length; n < i; n++)
                new KTSwapper(t[n]);
...
class KTToggle {
    ...
    static createInstances(e = "[data-kt-toggle]") {
        var t = document.getElementsByTagName("BODY")[0].querySelectorAll(e);
        if (t && t.length > 0)
            for (var n = 0, i = t.length; n < i; n++)
                new KTToggle(t[n]);
